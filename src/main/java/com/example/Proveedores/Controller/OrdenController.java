...
public class OrdenController {
    ...
    @GetMapping("/{id}")
    public Orden getOrden(@PathVariable String id_orden){
        return ordenService.ordenxId(id_orden);
    }

    @DeleteMapping
    public String deleteOrden(@PathVariable String id_orden){
        return ordenService.eliminarOrden(id_orden);
    }
}
